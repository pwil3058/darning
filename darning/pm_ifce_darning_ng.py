...
class Interface(pm_ifce.InterfaceMixin):
    ...
    def get_status_icon(status, is_dir):
        ...
        elif status.validity == patch_db_ng.Validity.REFRESHED:
            return icons.STOCK_FILE_REFRESHED
        elif status.validity == patch_db_ng.Validity.NEEDS_REFRESH:
            return icons.STOCK_FILE_NEEDS_REFRESH
        elif status.validity == patch_db_ng.Validity.UNREFRESHABLE:
