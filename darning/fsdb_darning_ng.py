...
STATUS_DECO_MAP = {
    ...
    patch_db_ng.Presence.ADDED: fsdb.Deco(pango.STYLE_NORMAL, "darkgreen"),
    patch_db_ng.Presence.REMOVED: fsdb.Deco(pango.STYLE_NORMAL, "red"),
    patch_db_ng.Presence.EXTANT: fsdb.Deco(pango.STYLE_NORMAL, "black"),
}
